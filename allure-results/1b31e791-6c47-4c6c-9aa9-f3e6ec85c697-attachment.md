...
```ts
  ...
  14 |     ])
  15 |     await newpage.locator("(//*[@class='_1psv1zeb9 _1psv1ze0 _7dzyg20 _1psv1ze9l _1psv1ze7o _1psv1ze2u _1psv1ze53']/div[@class='css-g5y9jx'])[1]").click();
  16 |     await newpage.locator("//a[@title='Cart']").click();
> 17 |     await newpage.getByText("Place Order ").click();
     |                                             ^ Error: locator.click: Target page, context or browser has been closed
  18 |     await newpage.pause();
  19 | })
```