let message1 : string = 'Hello';  //declare variable with type
...
let numarray : number[] =[10,20,30];  //array
let data : any ="this could be any data type" //if you don't know what data type to give then use this

//how to declare functions in typescript
function add(a:number, b:number) :number // this is for return data type
{
    return a+b;
}
